...
export default class extends React.Component<{}, ComponentState> {
    ...
    render() {
        ...
        return <>
            ...
            {/* @ts-expect-error ts-migrate(17004) FIXME: Cannot use JSX unless the '--jsx' flag is provided... Remove this comment to see the full error message */}
            <Link
                onInput={(exp: any) => this.setState({ exp: exp })}
            />
            {/* @ts-expect-error ts-migrate(17004) FIXME: Cannot use JSX unless the '--jsx' flag is provided... Remove this comment to see the full error message */}
            <br></br>
            {/* @ts-expect-error ts-migrate(17004) FIXME: Cannot use JSX unless the '--jsx' flag is provided... Remove this comment to see the full error message */}
            <div style={{
                ...
                <textarea
                    style={{
                        ...
                        top: '0',
                        left: '0',
                        // @ts-expect-error ts-migrate(2322) FIXME: Type '"1"' is not assignable to type '"-moz-initia... Remove this comment to see the full error message
                        zIndex: '1',
                        outline: 'none',
